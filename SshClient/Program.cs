...
namespace FxSsh
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            {
                Username = "dcnick3",
                HostAuth = ("test.com", "dcnick3", key),
                OnBanner = (_, a) => Console.WriteLine(a.Message),
                PasswordAuthHandler = null, //new InteractivePasswordAuthHandler(),
                ServiceName = "ssh-connection",
                UserKeys = new PublicKeyAlgorithm[]
                {
                    //new DssKey(), new RsaKey(), new Ed25519Key()
                    /**/
                }
            };
